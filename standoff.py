...
class StandoffAnnotation(object):
    """Standoff annotation usually recorded on a single line in a .ann file.
    """
    ...
    def __eq__(self, other):
        ...
        :rtype: bool
        """
        if not isinstance(other, StandoffAnnotation):
            return False
        if self.id != other.id:
            return False
...
class StandoffDocument(dict):
    ...
    def __init__(self, fp=None, no_newline=True, string=None):
        ...
        """
        super(StandoffDocument, self).__init__()
        if fp:
            with open(fp) as doc:
    ...
    def __eq__(self, other):
        ...
        :return:
        """
        if not isinstance(other, StandoffDocument):
            return False
...
class StandoffComment(object):
    """Standoff comment container
    """
    ...
    def __eq__(self, other):
        ...
        :rtype: bool
        """
        if not isinstance(other, StandoffComment):
            return False
        if self.id != other.id:
            return False
